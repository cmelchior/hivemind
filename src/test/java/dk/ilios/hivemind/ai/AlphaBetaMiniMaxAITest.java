...
public class AlphaBetaMiniMaxAITest {

    @Test
    public void testCanDetectWinTurnOne() {
        final HiveAI ai = new AlphaBetaMiniMaxAI("AlphaBeta", new SimpleHeuristicV1(), 1, 30000);
    ...
    public void testCanDetectWinTurnTwo() {
        final HiveAI ai = new AlphaBetaMiniMaxAI("AlphaBeta", new SimpleHeuristicV1(), 3, 30000);
